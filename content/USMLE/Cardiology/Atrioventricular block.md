...
- 3:2 block: regular AV block with 3 atrial depolarizations but only 2 atrial impulses that reach the ventricles <mark style="background: #FFF3A3A6;">(heart rate = ⅔ SA node rate)</span>
- 4:3 block: regular AV block with 4 atrial depolarizations but only 3 atrial impulses that reach the ventricles <mark style="background: #FFF3A3A6;">(heart rate = ¾ SA node rate)</span>
...
![[Pasted image 20230619221102.png|Pasted image 20230619221102.png]]
## 2:1 AV block 
- Description
...
- Risk of progression to [complete heart block](https://next.amboss.com/us/article/I50Ylg#Z610af26daeadb55232691548b0a56240): depends on level of block 
	...
	![[Pasted image 20230619221837.png|Pasted image 20230619221837.png]]
 # Ventriculophasic sinus arrhythmia
 Sinus rate variation of this type with complete heart block is called ventriculophasic sinus arrhythmia.
 ![[Pasted image 20230623224624.png|Pasted image 20230623224624.png]]